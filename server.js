...
app.post('/registro', async (req, res) => {
  ...
  try {
    ...
    const result = await mssql.query`INSERT INTO Users (Nombre, Apellido, NombreUsuario, Correo , ContrasenaHash) VALUES (${Nombre},${Apellidos},${NombreUsuario},${Correo} ${hashedPassword})`;
